...
* [Color Scheme Menu](https://github.com/Jon-Al/Flet_Extentions/blob/main/color_scheme_menu.py) - allows adding a [MenuBar](https://flet-controls-gallery.fly.dev/navigation/menubar) to an existing application.
